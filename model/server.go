...
type Server struct {
	...
	Note                   string `gorm:"type:longtext" json:"note,omitempty"`        // 管理员可见备注
	PublicNote             string `gorm:"type:longtext" json:"public_note,omitempty"` // 公开备注
	DisplayIndex           int    `json:"display_index"`                              // 展示排序，越大越靠前
	HideForGuest           bool   `json:"hide_for_guest,omitempty"`               // 对游客隐藏
	EnableDDNS             bool   `json:"enable_ddns,omitempty"`                  // 启用DDNS
	DDNSProfilesRaw        string `gorm:"default:'[]';column:ddns_profiles_raw;type:longtext" json:"-"`
	OverrideDDNSDomainsRaw string `gorm:"default:'{}';column:override_ddns_domains_raw;type:longtext" json:"-"`
